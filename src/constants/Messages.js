const messages = Object.freeze({
    NOTIFY_MISSING_EMAIL_PERMISSIONS: 'Oh, by the way, I can email you the restrooms with additional information like Google Maps navigation links, but need permission to email you.I put a card in your Amazon Alexa app in case you plan to grant the permission.',
